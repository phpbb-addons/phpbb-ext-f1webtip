    ...
    public function main($id, $mode)
    {
        ...
        switch ($mode) {
            ...
            case 'settings':
                ...
                $mod_ary = ([$mod_ary[0]['m_']] == true) ? $mod_ary[0]['m_'] : [];
                $admin_ary = $auth->acl_get_list(false, 'a_', false);
                $admin_ary = ([$admin_ary[0]['a_']] == true) ? $admin_ary[0]['a_'] : [];
            ...
            case 'drivers':
                ...
                if ($button_del && $driver_id != 0) {
                    ...
                    // Create a confirmbox with yes and no.
                        ...
                        confirm_box(false, sprintf($language->lang('ACP_F1_DRIVERS_DRIVER_DELETE_CONFIRM'), $drivername), build_hidden_fields([
                            'del'				     => true,
                            'driver_id'			=> $driver_id,
            ...
            case 'teams':
                ...
                if ($button_del && $team_id != 0) {
                    ...
                    // Create a confirmbox with yes and no.
                        ...
                        confirm_box(false, sprintf($language->lang('ACP_F1_TEAMS_TEAM_DELETE_CONFIRM'), $teamname), build_hidden_fields([
                            'del'				    => true,
                            'team_id'			 => $team_id,
                            'teamname'			=> $teamname,
                        ]), 'confirm_body.html');
            ...
            case 'races':
                ...
                if ($button_del && $race_id != 0) {
                    ...
                    // Create a confirmbox with yes and no.
                        ...
                        confirm_box(false, sprintf($language->lang('ACP_F1_RACES_RACE_DELETE_CONFIRM'), $racename), build_hidden_fields([
                            'del'				    => true,
                            'race_id'			 => $race_id,
                            'racename'			=> $racename,
                        ]), 'confirm_body.html');
